...
! function(e) {
  ...
  ! function(e) {
    function t(e, t, r, i) {
      if (P.number(e) && P.number(t) && P.number(r) && P.number(i)) return {
        start: n.create(e, t),
        end: n.create(r, i)
      };
  ...
  ! function(e) {
    ...
    function n(e) {
      var t = e;
      return P.defined(t) && r.is(t.range) && P.string(t.message) && (P.number(t.severity) || P.undefined(t.severity)) && (P.number(t.code) || P.string(t.code) || P.undefined(t.code)) && (P.string(t.source) || P.undefined(t.source))
    }
    e.create = t, e.is = n
      ...
      return Object.defineProperty(e.prototype, "edit", {
        ...
        if (p.is(e)) {
          ...
          if (!n) {
            ...
            this._workspaceEdit.documentChanges.push(i), n = new l(r), this._textEditChanges[t.uri] = n
          }
          return n
        }
        if (this._workspaceEdit || (this._workspaceEdit = {
  ...
  ! function(e) {
    ...
    function n(e) {
      var t = e;
      return !!(P.defined(t) && P.string(t.uri) && (P.undefined(t.languageId) || P.string(t.languageId)) && P.number(t.lineCount) && P.func(t.getText) && P.func(t.positionAt) && P.func(t.offsetAt))
    }
    e.create = t, e.is = n
  ...
  function(e) {
    ...
    function n(e, t) {
      ...
      function s() {
        ...
        if (d < e.length && 46 === e.charCodeAt(d)) {
          if (d++, !(d < e.length && o(e.charCodeAt(d)))) return x = m.UnexpectedEndOfNumber, e.substring(t, d);
          for (d++; d < e.length && o(e.charCodeAt(d));) d++
        }
        var n = d;
        if (d < e.length && (69 === e.charCodeAt(d) || 101 === e.charCodeAt(d)))
          if (d++, (d < e.length && 43 === e.charCodeAt(d) || 45 === e.charCodeAt(d)) && d++, d < e.length && o(e.charCodeAt(d))) {
            for (d++; d < e.length && o(e.charCodeAt(d));) d++;
            n = d
      ...
      function u() {
        ...
        if (r(t)) {
          do d++, h += String.fromCharCode(t), t = e.charCodeAt(d); while (r(t));
          return v = y.Trivia
        }
        if (i(t)) return d++, h += String.fromCharCode(t), 13 === t && 10 === e.charCodeAt(d) && (d++, h += "\n"), v = y.LineBreakTrivia;
        switch (t) {
          case 123:
          ...
          case 47:
            ...
            if (42 === e.charCodeAt(d + 1)) {
              ...
              return u || (d++, x = m.UnexpectedEndOfComment), h = e.substring(n, d), v = y.BlockCommentTrivia
            }
            return h += String.fromCharCode(t), d++, v = y.Unknown;
          case 45:
            if (h += String.fromCharCode(t), d++, d === p || !o(e.charCodeAt(d))) return v = y.Unknown;
          case 48:
          case 49:
          case 50:
          case 51:
    ...
    function h(e, t, r) {
      ...
      function l() {
        return h.getToken() !== y.StringLiteral ? (s(x.PropertyNameExpected, [], [y.CloseBraceToken, y.CommaToken]), !1) : (c(!1), h.getToken() === y.ColonToken ? (C(":"), a(), p() || s(x.ValueExpected, [], [y.CloseBraceToken, y.CommaToken])) : s(x.ColonExpected, [], [y.CloseBraceToken, y.CommaToken]), !0)
      }
      ...
      function f() {
        ...
        for (var e = !1; h.getToken() !== y.CloseBraceToken && h.getToken() !== y.EOF;) {
          if (h.getToken() === y.CommaToken) {
            if (e || s(x.ValueExpected, [], []), C(","), a(), h.getToken() === y.CloseBraceToken && E) break
      ...
      function d() {
        b(), a();
        for (var e = !1; h.getToken() !== y.CloseBracketToken && h.getToken() !== y.EOF;) h.getToken() === y.CommaToken ? (e || s(x.ValueExpected, [], []), C(","), a()) : e && s(x.CommaExpected, [], []), p() || s(x.ValueExpected, [], [y.CloseBracketToken, y.CommaToken]), e = !0;
      ...
      return a(), h.getToken() === y.EOF || (p() ? (h.getToken() !== y.EOF && s(x.EndOfFileExpected, [], []), !0) : (s(x.ValueExpected, [], []), !1))
    }
    var m, g = e("vscode-nls"),
    ...
    }(x = t.ParseErrorCode || (t.ParseErrorCode = {})), t.getParseErrorMessage = s, t.getLocation = u, t.parse = l, t.parseTree = f, t.findNodeAtLocation = d, t.getNodeValue = p, t.visit = h
        ...
        return e.prototype.doResolve = function(e) {
          ...
          var f = {},
            d = {
              add: function(e) {
                var t = f[e.label];
                t ? t.documentation || (t.documentation = e.documentation) : (f[e.label] = e, u && (e.textEdit = i.TextEdit.replace(u, e.insertText)), o.items.push(e))
              },
          ...
          return this.schemaService.getSchemaForResource(e.uri, n).then(function(t) {
            ...
            if (s && "string" === s.type) {
              var g = s;
              g.isKey && (p = !(s.parent && s.parent.value), m = s.parent ? s.parent : null, h = e.getText().substring(s.start + 1, s.end - 1), s.parent && (s = s.parent.parent))
            }
            if (s && "object" === s.type) {
              ...
              var y = "";
              p && (y = r.evaluateSeparatorAfter(e, e.offsetAt(u.end))), t ? r.getPropertyCompletions(t, n, s, p, y, d) : r.getSchemaLessPropertyCompletions(n, s, h, d);
              var x = s.getPath();
              r.contributions.forEach(function(t) {
                var n = t.collectPropertyCompletions(e.uri, x, c, p, "" === y, d);
                n && l.push(n)
              }), !t && c.length > 0 && '"' !== e.getText().charAt(a - c.length - 1) && d.add({
            ...
            var T = {};
            if (t ? r.getValueCompletions(t, n, s, a, S, d, T) : r.getSchemaLessValueCompletions(n, s, a, S, e, d), s) {
          ...
          if (t) {
            ...
            if ("array" === t.type)
              if (t.parent && "property" === t.parent.type) {
                ...
                e.visit(function(e) {
                  var t = e;
                  return "property" === e.type && t.key.value === d && t.value && "array" === t.value.type && t.value.items.forEach(function(e) {
                    c(e)
                  }), !0
                })
          ...
          if (t) {
            ...
            else if (t["enum"] && t["enum"].length > 0) o += this.getInsertTextForGuessedValue(t["enum"][0], "");
            else {
  ...
  function(e) {
    ...
    var r = e("vscode-languageserver-types"),
      i = function() {
        ...
        return e.prototype.doHover = function(e, t, i) {
          var o = e.offsetAt(t),
            a = i.getNodeFromOffset(o);
          if (!a || ("object" === a.type || "array" === a.type) && o > a.start + 1 && o < a.end - 1) return this.promise.resolve(void 0);
          var s = a;
          if ("string" === a.type) {
            var c = a;
            if (c.isKey) {
          ...
          for (var l = r.Range.create(e.positionAt(s.start), e.positionAt(s.end)), f = function(e) {
              var t = {
                contents: e,
                range: l
              };
              return t
            }, d = a.getPath(), p = this.contributions.length - 1; p >= 0; p--) {
            var h = this.contributions[p],
              m = h.getInfoContribution(e.uri, d);
            if (m) return m.then(function(e) {
              return f(e)
            })
          }
          return this.schemaService.getSchemaForResource(e.uri, i).then(function(e) {
            if (e) {
              ...
              var r = null,
                ...
                c = null;
              t.every(function(e) {
                if (e.node === a && !e.inverted && e.schema && (r = r || e.schema.title, o = o || e.schema.description, e.schema["enum"] && e.schema.enumDescriptions)) {
                  var t = e.schema["enum"].indexOf(a.getValue());
                  s = e.schema.enumDescriptions[t], c = e.schema["enum"][t], "string" != typeof c && (c = JSON.stringify(c))
                }
                return !0
              });
              var u = "";
              return r && (u = n(r)), o && (u.length > 0 && (u += "\n\n"), u += n(o)), s && (u.length > 0 && (u += "\n\n"), u += "`" + n(c) + "`: " + n(s)), f([u])
            }
          })
        }, e
      }();
          ...
          return this.schemaService.getSchemaForResource(e.uri, t).then(function(n) {
            ...
            if (n) {
              ...
              for (var a = {}, s = 0, c = o; s < c.length; s++) {
                var u = c[s];
                if (!u.inverted && u.schema && "color" === u.schema.format && u.node && "string" === u.node.type) {
                  var l = String(u.node.start);
                  a[l] || (i.push(r.Range.create(e.positionAt(u.node.start), e.positionAt(u.node.end))), a[l] = !0)
                }
              }
            }
            return i
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-json-languageservice/parser/jsonParser", ["require", "exports", "jsonc-parser", "../utils/objects", "vscode-nls"], e)
}(function(e, t) {
  function n(e, t) {
    function n() {
      for (;;) {
    ...
    function a(t, r, o, a, s) {
      if (void 0 === o && (o = null), void 0 === a && (a = []), void 0 === s && (s = []), 0 === O.errors.length || O.errors[0].location.start !== E.getTokenOffset()) {
    ...
    function c() {
      switch (E.getTokenError()) {
        ...
        case i.ScanError.InvalidEscapeCharacter:
          return a(s("InvalidEscapeCharacter", "Invalid escape character in string"), r.InvalidEscapeCharacter), !0;
        ...
        case i.ScanError.InvalidCharacter:
          return a(s("InvalidCharacter", "Invalid characters in string. Control characters must be escaped."), r.InvalidCharacter), !0
      }
      return !1
    }
    ...
    function y(e, t) {
      ...
      var u = 0;
      if (c.addItem(k(c, u++)))
        for (; o(i.SyntaxKind.CommaToken);) c.addItem(k(c, u++)) || I || a(s("ValueExpected", "Value expected"), r.Undefined);
      return E.getToken() !== i.SyntaxKind.CloseBracketToken ? a(s("ExpectedCloseBracket", "Expected comma or closing bracket"), r.Undefined, c) : g(c, !0)
    }
    ...
    function x(e, t) {
      ...
      if (!o) {
        if (E.getToken() === i.SyntaxKind.Unknown) {
          ...
          c.match(/^['\w]/) && a(s("DoubleQuotesExpected", "Property keys must be doublequoted"), r.Undefined)
        }
        return null
      }
      var u = new h(e, o);
      return t[o.value] && O.warnings.push({
        location: {
          start: u.key.start,
          end: u.key.end
        },
    ...
    function b(e, t) {
      ...
      if (c.addProperty(x(c, u)))
        for (; o(i.SyntaxKind.CommaToken);) c.addProperty(x(c, u)) || I || a(s("PropertyExpected", "Property expected"), r.Undefined);
      return E.getToken() !== i.SyntaxKind.CloseBraceToken ? a(s("ExpectedCloseBrace", "Expected comma or closing brace"), r.Undefined, c) : g(c, !0)
    }
    ...
    function T(e, t) {
      ...
      if (!c()) {
        ...
        try {
          var u = JSON.parse(o);
          if ("number" != typeof u) return a(s("InvalidNumberFormat", "Invalid number format"), r.Undefined, n);
          n.value = u
        } catch (l) {
    ...
    return n(), O.root = k(null, null), O.root ? E.getToken() !== i.SyntaxKind.EOF && a(s("End of file expected", "End of file expected"), r.Undefined) : a(s("Invalid symbol", "Expected a JSON object, array or literal"), r.Undefined), O
  }
  var r, i = e("jsonc-parser"),
    o = e("../utils/objects"),
    a = e("vscode-nls"),
    ...
    return e.prototype.getPath = function() {
      ...
      if (void 0 === i && (i = -1), i === -1 || this.contains(i)) {
        if (Array.isArray(e.type) ? e.type.indexOf(this.type) === -1 && t.warnings.push({
          ...
          var c = new g,
            u = [];
          this.validate(e.not, c, u, i), c.hasErrors() || t.warnings.push({
            location: {
              start: this.start,
              end: this.end
            },
        ...
        var l = function(e, r) {
            ...
            if (a.validate(e, t, n), t.hasErrors() || i.push(e), o)
              if (r || t.hasErrors() || o.validationResult.hasErrors()) {
                ...
                s > 0 ? o = {
                  ...
                  validationResult: t,
                  matchingSchemas: n
                } : 0 === s && (o.matchingSchemas.push.apply(o.matchingSchemas, n), o.validationResult.mergeEnumValueMismatch(t))
              } else o.matchingSchemas.push.apply(o.matchingSchemas, n), o.validationResult.propertiesMatches += t.propertiesMatches, o.validationResult.propertiesValueMatches += t.propertiesValueMatches;
            else o = {
              schema: e,
              validationResult: t,
              matchingSchemas: n
          ...
          }), null !== o && (t.merge(o.validationResult), t.propertiesMatches += o.validationResult.propertiesMatches, t.propertiesValueMatches += o.validationResult.propertiesValueMatches, n && n.push.apply(n, o.matchingSchemas)), i.length
        };
        if (Array.isArray(e.anyOf) && l(e.anyOf, !1), Array.isArray(e.oneOf) && l(e.oneOf, !0), Array.isArray(e["enum"])) {
          ...
          d ? t.enumValueMatch = !0 : (t.warnings.push({
            location: {
              start: this.start,
              end: this.end
            },
            code: r.EnumValueMismatch,
            message: e.errorMessage || s("enumWarning", "Value is not accepted. Valid values: {0}", JSON.stringify(e["enum"]))
          }), t.mismatchedEnumValues = e["enum"])
        }
        e.deprecationMessage && this.parent && t.warnings.push({
          location: {
      ...
      if (void 0 === i && (i = -1), i === -1 || this.contains(i)) {
        if (e.prototype.validate.call(this, t, n, r, i), Array.isArray(t.items)) {
          ...
          a.forEach(function(e, t) {
            var s = new g,
              c = o.items[t];
            c ? (c.validate(e, s, r, i), n.mergePropertyMatch(s)) : o.items.length >= a.length && n.propertiesValueMatches++
          }), t.additionalItems === !1 && this.items.length > a.length ? n.warnings.push({
            location: {
              start: this.start,
              end: this.end
            },
            message: s("additionalItemsWarning", "Array has too many items according to schema. Expected {0} or fewer", a.length)
          }) : this.items.length >= a.length && (n.propertiesValueMatches += this.items.length - a.length)
        ...
        if (t.minItems && this.items.length < t.minItems && n.warnings.push({
            ...
            message: s("minItemsWarning", "Array has too few items. Expected {0} or more", t.minItems)
          }), t.maxItems && this.items.length > t.maxItems && n.warnings.push({
            location: {
              start: this.start,
              end: this.end
            },
            message: s("maxItemsWarning", "Array has too many items. Expected {0} or fewer", t.minItems)
          }), t.uniqueItems === !0) {
  ...
  var d = function(e) {
    ...
    return __extends(t, e), t.prototype.getValue = function() {
      ...
      if (void 0 === i && (i = -1), i === -1 || this.contains(i)) {
        ...
        var a = this.getValue();
        "number" == typeof t.multipleOf && a % t.multipleOf !== 0 && n.warnings.push({
          location: {
            start: this.start,
            end: this.end
          },
          message: s("multipleOfWarning", "Value is not divisible by {0}", t.multipleOf)
        }), "number" == typeof t.minimum && (t.exclusiveMinimum && a <= t.minimum && n.warnings.push({
          location: {
            start: this.start,
            end: this.end
          },
          message: s("exclusiveMinimumWarning", "Value is below the exclusive minimum of {0}", t.minimum)
        }), !t.exclusiveMinimum && a < t.minimum && n.warnings.push({
          location: {
            start: this.start,
            end: this.end
          },
          message: s("minimumWarning", "Value is below the minimum of {0}", t.minimum)
        })), "number" == typeof t.maximum && (t.exclusiveMaximum && a >= t.maximum && n.warnings.push({
          location: {
            start: this.start,
            end: this.end
          },
          message: s("exclusiveMaximumWarning", "Value is above the exclusive maximum of {0}", t.maximum)
        }), !t.exclusiveMaximum && a > t.maximum && n.warnings.push({
          location: {
            start: this.start,
            end: this.end
          },
  ...
  var p = function(e) {
    ...
    return __extends(t, e), t.prototype.getValue = function() {
      ...
      if (void 0 === i && (i = -1), (i === -1 || this.contains(i)) && (e.prototype.validate.call(this, t, n, r, i), t.minLength && this.value.length < t.minLength && n.warnings.push({
          ...
          message: s("minLengthWarning", "String is shorter than the minimum length of {0}", t.minLength)
        }), t.maxLength && this.value.length > t.maxLength && n.warnings.push({
          location: {
            start: this.start,
            end: this.end
          },
          message: s("maxLengthWarning", "String is longer than the maximum length of {0}", t.maxLength)
        }), t.pattern)) {
        ...
        o.test(this.value) || n.warnings.push({
          ...
          message: t.patternErrorMessage || t.errorMessage || s("patternWarning", 'String does not match the pattern of "{0}"', t.pattern)
        })
      }
    }, t
  }(c);
  ...
  var m = function(e) {
    ...
    return __extends(t, e), t.prototype.getChildNodes = function() {
      ...
      if (void 0 === i && (i = -1), i === -1 || this.contains(i)) {
        ...
        t.properties && Object.keys(t.properties).forEach(function(e) {
        ...
        }), "object" == typeof t.additionalProperties ? c.forEach(function(e) {
          var o = a[e];
          if (o) {
            var s = new g;
          ...
          if (r) {
            ...
            n.warnings.push({
              ...
              message: t.errorMessage || s("DisallowedExtraPropWarning", "Property {0} is not allowed", e)
            })
          }
          ...
          message: s("MaxPropWarning", "Object has more properties than limit of {0}", t.maxProperties)
        }), t.minProperties && this.properties.length < t.minProperties && n.warnings.push({
          location: {
            start: this.start,
            end: this.end
          },
          message: s("MinPropWarning", "Object has fewer properties than the required number of {0}", t.minProperties)
          ...
          if (c)
            if (Array.isArray(t.dependencies[e])) {
              ...
              u.forEach(function(t) {
                a[t] ? n.propertiesValueMatches++ : n.warnings.push({
                  location: {
                    start: o.start,
                    end: o.end
                  },
                  message: s("RequiredDependentPropWarning", "Object is missing property {0} required by property {1}", t, e)
                })
              })
    ...
    return e.prototype.hasErrors = function() {
      ...
      if (this.mismatchedEnumValues && e.mismatchedEnumValues) {
        ...
        for (var t = 0, n = this.warnings; t < n.length; t++) {
          var i = n[t];
          i.code === r.EnumValueMismatch && (i.message = s("enumWarning", "Value is not accepted. Valid values: {0}", JSON.stringify(this.mismatchedEnumValues)))
        }
...
function(e) {
  ...
  var o = function() {
    ...
    return e.isUri = function(t) {
      ...
      get: function() {
        if (!this._fsPath) {
          var t;
          t = this._authority && this._path && "file" === this.scheme ? "//" + this._authority + this._path : e._driveLetterPath.test(this._path) ? this._path[1].toLowerCase() + this._path.substr(2) : this._path, a && (t = t.replace(/\//g, "\\")), this._fsPath = t
        }
        return this._fsPath
      },
      enumerable: !0,
      ...
      var n = t.scheme,
        ...
        o = t.query,
        a = t.fragment;
      if (void 0 === n ? n = this.scheme : null === n && (n = ""), void 0 === r ? r = this.authority : null === r && (r = ""), void 0 === i ? i = this.path : null === i && (i = ""), void 0 === o ? o = this.query : null === o && (o = ""), void 0 === a ? a = this.fragment : null === a && (a = ""), n === this.scheme && r === this.authority && i === this.path && o === this.query && a === this.fragment) return this;
      var s = new e;
      ...
      var n = new e;
      if (n._scheme = "file", a && (t = t.replace(/\\/g, e._slash)), t[0] === e._slash && t[0] === t[1]) {
  ...
  o._empty = "", o._slash = "/", o._regexp = /^(([^:\/?#]+?):)?(\/\/([^\/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/, o._driveLetterPath = /^\/[a-zA-z]:/, o._upperCaseDrive = /^(\/)?([A-Z]:)/, o._schemePattern = /^\w[\w\d+.-]*$/, o._singleSlashStart = /^\//, o._doubleSlashStart = /^\/\//, t["default"] = o;
  var a;
      ...
      return e.prototype.getRegisteredSchemaIds = function(e) {
        ...
        var n = this,
          ...
          c = function(e, t, n) {
            var i = a(t, n);
            if (i)
              for (var o in i) i.hasOwnProperty(o) && !e.hasOwnProperty(o) && (e[o] = i[o]);
          ...
          l = function(e, t, r) {
            ...
            for (var i = [e], o = [], a = [], s = function() {
              ...
              if (!(o.indexOf(d) >= 0)) {
                ...
                s(d.items, d.additionalProperties, d.not), l(d.definitions, d.properties, d.patternProperties, d.dependencies), f(d.anyOf, d.allOf, d.oneOf, d.items)
              }
            }
        ...
        if (t && t.root && "object" === t.root.type) {
          ...
          if (n.length > 0) {
            ...
            if (r && o.startsWith(r, ".") && this.contextService && (r = this.contextService.resolveRelativePath(r, e)), r) {
              var i = this.normalizeId(r);
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonFormatter", ["require", "exports", "jsonc-parser", "vscode-languageserver-types", "../utils/strings"], e)
  }(function(e, t) {
    function n(e, t, n) {
      function u() {
      ...
      function l() {
        var e = O.scan();
        for (C = !1; e === a.SyntaxKind.Trivia || e === a.SyntaxKind.LineBreakTrivia;) C = C || e === a.SyntaxKind.LineBreakTrivia, e = O.scan();
      ...
      var d, p, h, m, g, v = e.getText();
      if (t) {
        m = e.offsetAt(t.start), g = e.offsetAt(t.end);
        var y = s.Position.create(t.start.line, 0);
        h = e.offsetAt(y);
        for (var x = e.offsetAt(s.Position.create(t.end.line + 1, 0)), b = e.offsetAt(s.Position.create(t.end.line, 0)); x > b && o(v, x - 1);) x--;
      ...
      for (; I !== a.SyntaxKind.EOF;) {
        for (var _ = O.getTokenOffset() + O.getTokenLength() + h, P = l(), V = ""; !C && (P === a.SyntaxKind.LineCommentTrivia || P === a.SyntaxKind.BlockCommentTrivia);) {
          var F = O.getTokenOffset() + h;
          f(" ", _, F), _ = O.getTokenOffset() + O.getTokenLength() + h, V = P === a.SyntaxKind.LineCommentTrivia ? u() : "", P = l()
        }
        if (P === a.SyntaxKind.CloseBraceToken) I !== a.SyntaxKind.OpenBraceToken && (k--, V = u());
          ...
          switch (I) {
            ...
            case a.SyntaxKind.CloseBracketToken:
              P === a.SyntaxKind.LineCommentTrivia || P === a.SyntaxKind.BlockCommentTrivia ? V = " " : P !== a.SyntaxKind.CommaToken && P !== a.SyntaxKind.EOF && (E = !0)
  ...
  function(e) {
    ...
    var r = monaco.Promise,
      ...
      s = function() {
        function e(e, t) {
          this._ctx = e, this._languageSettings = t.languageSettings, this._languageId = t.languageId, this._languageService = i.getLanguageService({
            promiseConstructor: a
