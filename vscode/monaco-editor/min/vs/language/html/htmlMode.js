...
! function(e) {
  ...
  } else "function" == typeof define && define.amd && define("vs/language/html/workerManager", ["require", "exports"], e)
}(function(e, t) {
  function n(e) {
    var t, n, i = new r(function(e, r) {
      t = e, n = r
    }, function() {});
    return e.then(t, n), i
  }
...
function(e) {
  ...
  ! function(e) {
    function t(e, t, r, i) {
      if (K.number(e) && K.number(t) && K.number(r) && K.number(i)) return {
        start: n.create(e, t),
        end: n.create(r, i)
      };
  ...
  ! function(e) {
    function t(e, t, n, r, i) {
      ...
      return K.defined(n) && (o.severity = n), K.defined(r) && (o.code = r), K.defined(i) && (o.source = i), o
    }

    function n(e) {
      var t = e;
      return K.defined(t) && r.is(t.range) && K.string(t.message) && (K.number(t.severity) || K.undefined(t.severity)) && (K.number(t.code) || K.string(t.code) || K.undefined(t.code)) && (K.string(t.source) || K.undefined(t.source))
    }
    e.create = t, e.is = n
  ...
  ! function(e) {
    ...
    function n(e) {
      var t = e;
      return K.defined(t) && K.string(t.uri) && K.string(t.languageId) && K.number(t.version) && K.string(t.text)
    }
    e.create = t, e.is = n
  ...
  ! function(e) {
    function t(e, t) {
      ...
      return K.defined(t) && (i.documentation = t), K.defined(n) ? i.parameters = n : i.parameters = [], i
    }
    e.create = t
  ...
  t.DocumentLink = T,
    function(e) {
      ...
      e.create = t, e.is = n
    }(T = t.DocumentLink || (t.DocumentLink = {})), t.DocumentLink = T, t.EOL = ["\n", "\r\n", "\r"];
  var M;
  ! function(e) {
    function t(e, t, n, r) {
    ...
    function n(e) {
      var t = e;
      return !!(K.defined(t) && K.string(t.uri) && (K.undefined(t.languageId) || K.string(t.languageId)) && K.number(t.lineCount) && K.func(t.getText) && K.func(t.positionAt) && K.func(t.offsetAt))
    }
    e.create = t, e.is = n
  ...
  ! function(e) {
    ...
    e.defined = t, e.undefined = n, e["boolean"] = r, e.string = i, e.number = o, e.func = a, e.typedArray = u
  }(K || (K = {}))
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vs/language/html/languageFeatures", ["require", "exports", "vscode-languageserver-types"], e)
  }(function(e, t) {
    function n(e) {
      switch (e) {
    ...
    function o(e) {
      if (e) return {
        start: i(e.getStartPosition()),
        end: i(e.getEndPosition())
      }
    }
    ...
    var p = function() {
      ...
      return Object.defineProperty(e.prototype, "triggerCharacters", {
        ...
        return f(n, this._worker(r).then(function(e) {
          ...
          if (e) {
            var t = e.items.map(function(e) {
              ...
              return e.textEdit && (t.range = a(e.textEdit.range), t.insertText = e.textEdit.newText), e.insertTextFormat === l.InsertTextFormat.Snippet && (t.insertText = {
                value: t.insertText
              }), t
            });
            return {
    ...
    var v = function() {
      ...
      return e.prototype.provideLinks = function(e, t) {
        var n = e.uri;
        return f(t, this._worker(n).then(function(e) {
    ...
    var y = function() {
      ...
      return e.prototype.provideDocumentRangeFormattingEdits = function(e, t, n, r) {
        var i = e.uri;
        return f(r, this._worker(i).then(function(e) {
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vs/language/html/htmlMode", ["require", "exports", "./workerManager", "./languageFeatures"], e)
  }(function(e, t) {
    function n(e) {
      var t = [],
