...
! function(e) {
  ...
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/cssScanner", ["require", "exports"], e)
}(function(e, t) {
  ...
  var i = "a".charCodeAt(0),
    ...
    K = "!".charCodeAt(0),
    $ = {};
  $[N] = n.SemiColon, $[U] = n.Colon, $[M] = n.CurlyL, $[j] = n.CurlyR, $[V] = n.BracketR, $[L] = n.BracketL, $[v] = n.ParenthesisL, $[x] = n.ParenthesisR, $[B] = n.Comma;
  var W = {};
  W.em = n.EMS, W.ex = n.EXS, W.px = n.Length, W.cm = n.Length, W.mm = n.Length, W["in"] = n.Length, W.pt = n.Length, W.pc = n.Length, W.deg = n.Angle, W.rad = n.Angle, W.grad = n.Angle, W.ms = n.Time, W.s = n.Time, W.hz = n.Freq, W.khz = n.Freq, W["%"] = n.Percentage, W.dpi = n.Resolution, W.dpcm = n.Resolution;
  var G = function() {
    function e() {
    ...
    return e.prototype.setSource = function(e) {
      ...
      if (this.stream.advanceIfChar(F)) return t = ["#"], this._name(t) ? this.finishToken(e, n.Hash, t.join("")) : this.finishToken(e, n.Delim);
      ...
      var e, t = 0;
      return this.stream.peekChar() === q && (t = 1), e = this.stream.peekChar(t), e >= d && h >= e ? (this.stream.advance(t + 1), this.stream.advanceWhileChar(function(e) {
      ...
      switch (t) {
        ...
        case A:
        case P:
          return this.stream.advance(1), e.push(String.fromCharCode(t)), t === _ && this.stream.advanceIfChar(P) && e.push("\n"), !0
      }
      return !1
      ...
      if (n === E) {
        ...
        for (var r = 0; 6 > r && (n >= d && h >= n || n >= i && o >= n || n >= s && l >= n);) this.stream.advance(1), n = this.stream.peekChar(), r++;
        if (r > 0) {
          try {
        ...
        if (n !== _ && n !== A && n !== P) return this.stream.advance(1), e.push(String.fromCharCode(n)), !0;
        if (t) return this._newline(e)
      }
      return !1
    }, e.prototype._stringChar = function(e, t) {
      var n = this.stream.peekChar();
      return 0 !== n && n !== e && n !== E && n !== _ && n !== A && n !== P ? (this.stream.advance(1), t.push(String.fromCharCode(n)), !0) : !1
      ...
      var t = this.stream.peekChar();
      return 0 !== t && t !== O && t !== D && t != v && t != x && t != R && t != z && t != P && t != A && t != _ ? (this.stream.advance(1), e.push(String.fromCharCode(t)), !0) : !1
      ...
      var t = this.stream.peekChar();
      return t === b || t >= i && a >= t || t >= s && c >= t || t >= 128 && 65535 >= t ? (this.stream.advance(1), e.push(String.fromCharCode(t)), !0) : !1
      ...
      var t = this.stream.peekChar();
      return t === b || t === g || t >= i && a >= t || t >= s && c >= t || t >= d && h >= t || t >= 128 && 65535 >= t ? (this.stream.advance(1), e.push(String.fromCharCode(t)), !0) : !1
    }, e
  }();
  t.Scanner = G
});
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/cssNodes", ["require", "exports"], e)
}(function(e, t) {
  function n(e, t) {
    var n = null;
    return !e || t < e.offset || t > e.end ? null : (e.accept(function(e) {
      return -1 === e.offset && -1 === e.length ? !0 : e.offset <= t && e.end >= t ? (n ? e.length <= n.length && (n = e) : n = e, !0) : !1
    }), n)
  }
  ...
  }(a = t.ReferenceType || (t.ReferenceType = {})), t.getNodeAtOffset = n, t.getNodePath = r, t.getParentDeclaration = i;
  var s = function() {
    function e(e, t, n) {
    ...
    return Object.defineProperty(e.prototype, "end", {
      ...
      return void 0 === e && (e = !1), this.issues && this.issues.length > 0 ? !0 : e && this.children && this.children.some(function(e) {
  ...
  var X = function(e) {
    ...
    return __extends(t, e), Object.defineProperty(t.prototype, "type", {
      ...
      for (var e, t = this.getText(), n = 0, r = ".".charCodeAt(0), i = "0".charCodeAt(0), o = "9".charCodeAt(0), a = 0, s = t.length; s > a && (e = t.charCodeAt(a), e >= i && o >= e || e === r); a++) n += 1;
      return {
...
function(e) {
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/cssErrors", ["require", "exports", "vscode-nls"], e)
  }(function(e, t) {
    Object.defineProperty(t, "__esModule", {
      value: !0
    });
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-css-languageservice/data/browsers", ["require", "exports"], e)
  }(function(e, t) {
    t.data = {
      css: {
        atdirectives: [{
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/languageFacts", ["require", "exports", "../parser/cssNodes", "../data/browsers", "vscode-nls"], e)
  }(function(e, t) {
    function n(e) {
      var t = e.getName();
    ...
    function c(e) {
      ...
      return e ? e.split(",").forEach(function(e) {
        if (e = e.trim(), "all" === e) n.all = !0, r = Number.MAX_VALUE;
          ...
          for (var i in t.browserNames) 0 === e.indexOf(i) && (n[i] = e.substring(i.length).trim(), r++)
    ...
    t.getProperties = d;
    var k, T = f.data.css.atdirectives;
    t.getAtDirectives = h;
    var S, F = f.data.css.pseudoelements;
    t.getPseudoElements = p;
    var C, E = f.data.css.pseudoclasses;
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/cssParser", ["require", "exports", "./cssScanner", "./cssNodes", "./cssErrors", "../services/languageFacts"], e)
  }(function(e, t) {
    Object.defineProperty(t, "__esModule", {
      value: !0
    });
    var n = e("./cssScanner"),
      ...
      a = function() {
        ...
        return e.prototype.peek = function(e, t, n) {
          return void 0 === n && (n = !0), e !== this.token.type ? !1 : "undefined" != typeof t ? n ? t.toLowerCase() === this.token.text.toLowerCase() : t === this.token.text : !0
          ...
          for (var r = 0; r < t.length; r++)
            if (this.peek(e, t[r], n)) return this.consumeToken(), !0;
          return !1
          ...
          do {
            ...
            do {
              ...
              for (a && (e.addChild(a), o = !0, t = !1, this.peek(n.TokenType.EOF) || !this._needsSemicolonAfter(a) || this.accept(n.TokenType.SemiColon) || this.markError(e, i.ParseError.SemiColonExpected)); this.accept(n.TokenType.SemiColon) || this.accept(n.TokenType.CDO) || this.accept(n.TokenType.CDC);) o = !0, t = !1
            } while (o);
          ...
          for (var o = e(); t.addChild(o) && !this.peek(n.TokenType.CurlyR);) {
            if (this._needsSemicolonAfter(o) && !this.accept(n.TokenType.SemiColon)) return this.finish(t, i.ParseError.SemiColonExpected, [n.TokenType.SemiColon, n.TokenType.CurlyR]);
          ...
          if (!this.accept(n.TokenType.Colon)) return this.finish(e, i.ParseError.ColonExpected, [n.TokenType.Colon]);
          ...
          if (this.peek(n.TokenType.CurlyL)) {
            ...
            if (o.setDeclarations(a) && !a.isErroneous(!0) && (o.addChild(this._parsePrio()), this.peek(n.TokenType.SemiColon))) return this.finish(o), e.setPropertySet(o), e.semicolonPosition = this.token.offset, this.finish(e);
            this.restoreAtMark(t)
          }
          var s = this._parseExpr();
          return s && !s.isErroneous(!0) && (this._parsePrio(), this.peek(n.TokenType.SemiColon)) ? (e.setValue(s), e.semicolonPosition = this.token.offset, this.finish(e)) : (this.restoreAtMark(t), e.addChild(this._parseCustomPropertyValue()), e.addChild(this._parsePrio()), this.token.offset === e.colonPosition + 1 ? this.finish(e, i.ParseError.PropertyValueExpected) : this.finish(e))
          ...
          e: for (;;) {
            switch (this.token.type) {
              ...
              case n.TokenType.EOF:
                ...
                return s > 0 ? l = i.ParseError.RightSquareBracketExpected : a > 0 && (l = i.ParseError.RightParenthesisExpected), this.finish(e, l)
            }
            this.consumeToken()
          }
          return this.finish(e)
          ...
          return this.accept(n.TokenType.AtKeyword, "@import") ? e.addChild(this._parseURILiteral()) || e.addChild(this._parseStringLiteral()) ? (e.setMedialist(this._parseMediaList()), this.finish(e)) : this.finish(e, i.ParseError.URIOrStringExpected) : null
        }, e.prototype._parseNamespace = function() {
          var e = this.create(r.Namespace);
          return this.accept(n.TokenType.AtKeyword, "@namespace") ? e.addChild(this._parseURILiteral()) || (e.addChild(this._parseIdent()), e.addChild(this._parseURILiteral()) || e.addChild(this._parseStringLiteral())) ? this.accept(n.TokenType.SemiColon) ? this.finish(e) : this.finish(e, i.ParseError.SemiColonExpected) : this.finish(e, i.ParseError.URIExpected, [n.TokenType.SemiColon]) : null
          ...
          if (!this.peek(n.TokenType.AtKeyword, "@-ms-viewport") && !this.peek(n.TokenType.AtKeyword, "@-o-viewport") && !this.peek(n.TokenType.AtKeyword, "@viewport")) return null;
          ...
          for (; this.accept(n.TokenType.Comma);)
            if (!e.addChild(this._parseIdent()) && !this.accept(n.TokenType.Percentage)) return this.finish(e, i.ParseError.PercentageExpected);
          ...
          if (!t.addChild(this._parseMediaQuery([n.TokenType.CurlyL]))) return this.finish(t, i.ParseError.IdentifierExpected);
          for (; this.accept(n.TokenType.Comma);)
            if (!t.addChild(this._parseMediaQuery([n.TokenType.CurlyL]))) return this.finish(t, i.ParseError.IdentifierExpected);
          ...
          if (!this.peek(n.TokenType.ParenthesisL)) {
            if (this.accept(n.TokenType.Ident, "only", !0) || this.accept(n.TokenType.Ident, "not", !0), !t.addChild(this._parseIdent())) return null;
            a = !0, o = this.accept(n.TokenType.Ident, "and", !0)
          }
          for (; o;) {
            if (!this.accept(n.TokenType.ParenthesisL)) return a ? this.finish(t, i.ParseError.LeftParenthesisExpected, [], e) : null;
            if (!t.addChild(this._parseMediaFeatureName())) return this.finish(t, i.ParseError.IdentifierExpected, [], e);
            if (this.accept(n.TokenType.Colon) && !t.addChild(this._parseExpr())) return this.finish(t, i.ParseError.TermExpected, [], e);
          ...
          if (e.getMediums().addChild(this._parseMedium())) {
            for (; this.accept(n.TokenType.Comma);)
              if (!e.getMediums().addChild(this._parseMedium())) return this.finish(e, i.ParseError.IdentifierExpected);
            return this.finish(e)
          }
          return null
          ...
          if (this.accept(n.TokenType.Delim, ">")) {
            ...
            if (!this.hasWhitespace() && this.accept(n.TokenType.Delim, ">")) {
              if (!this.hasWhitespace() && this.accept(n.TokenType.Delim, ">")) return e.type = r.NodeType.SelectorCombinatorShadowPiercingDescendant, this.finish(e);
              this.restoreAtMark(t)
            }
            return e.type = r.NodeType.SelectorCombinatorParent, this.finish(e)
          }
          if (this.accept(n.TokenType.Delim, "+")) return e.type = r.NodeType.SelectorCombinatorSibling, this.finish(e);
          if (this.accept(n.TokenType.Delim, "~")) return e.type = r.NodeType.SelectorCombinatorAllSiblings, this.finish(e);
          if (!this.accept(n.TokenType.Delim, "/")) return null;
          var t = this.mark();
          return !this.hasWhitespace() && this.accept(n.TokenType.Ident, "deep") && !this.hasWhitespace() && this.accept(n.TokenType.Delim, "/") ? (e.type = r.NodeType.SelectorCombinatorShadowPiercingDescendant, this.finish(e)) : void this.restoreAtMark(t)
          ...
          return this.accept(n.TokenType.Ident), this.hasWhitespace() || !this.accept(n.TokenType.ParenthesisL) ? (this.restoreAtMark(e), null) : (t.addChild(this._parseURLArgument()), this.accept(n.TokenType.ParenthesisR) ? this.finish(t) : this.finish(t, i.ParseError.RightParenthesisExpected))
        }, e.prototype._parseURLArgument = function() {
          var e = this.create(r.Node);
          return this.accept(n.TokenType.String) || this.accept(n.TokenType.BadString) || this.acceptUnquotedString() ? this.finish(e) : null
          ...
          if (t.getArguments().addChild(this._parseFunctionArgument()))
            for (; this.accept(n.TokenType.Comma);) t.getArguments().addChild(this._parseFunctionArgument()) || this.markError(t, i.ParseError.ExpressionExpected);
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-css-languageservice/utils/arrays", ["require", "exports"], e)
  }(function(e, t) {
    function n(e, t) {
      var n = 0,
        r = e.length;
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/cssSymbolScope", ["require", "exports", "./cssNodes", "../utils/arrays"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
  ...
  var s = function() {
    ...
    return e.prototype.addSymbol = function(e, t, n, r) {
      ...
      return e.getSelectors().getChildren().forEach(function(e) {
        e instanceof n.Selector && 1 === e.getChildren().length && t.addSymbol(new a(e.getChild(0).getText(), null, e, n.ReferenceType.Rule))
      }), !0
    ...
    return e.prototype.findSymbolsAtOffset = function(e, t) {
      ...
      if (e instanceof n.Identifier) {
        ...
        if (r) {
          ...
          if (("animation" === i || "animation-name" === i) && r.getValue() && r.getValue().offset === e.offset) return [n.ReferenceType.Keyframe]
        }
...
function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/utils/strings", ["require", "exports"], e)
}(function(e, t) {
  function n(e, t) {
  ...
  function i(e, t, n) {
    ...
    for (i = 1; i < e.length + 1; ++i)
      for (o = 1; o < t.length + 1; ++o) e[i - 1] === t[o - 1] ? a[i][o] = a[i - 1][o - 1] + 1 : a[i][o] = Math.max(a[i - 1][o], a[i][o - 1]);
...
function(e) {
  ...
  ! function(e) {
    function t(e, t, r, i) {
      if (D.number(e) && D.number(t) && D.number(r) && D.number(i)) return {
        start: n.create(e, t),
        end: n.create(r, i)
      };
  ...
  ! function(e) {
    function t(e, t, n, r, i) {
      ...
      return D.defined(n) && (o.severity = n), D.defined(r) && (o.code = r), D.defined(i) && (o.source = i), o
    }

    function n(e) {
      var t = e;
      return D.defined(t) && r.is(t.range) && D.string(t.message) && (D.number(t.severity) || D.undefined(t.severity)) && (D.number(t.code) || D.string(t.code) || D.undefined(t.code)) && (D.string(t.source) || D.undefined(t.source))
    }
    e.create = t, e.is = n
      ...
      return Object.defineProperty(e.prototype, "edit", {
        ...
        if (m.is(e)) {
          ...
          if (!n) {
            ...
            this._workspaceEdit.documentChanges.push(i), n = new d(r), this._textEditChanges[t.uri] = n
          }
          return n
        }
        if (this._workspaceEdit || (this._workspaceEdit = {
  ...
  ! function(e) {
    function t(e, t) {
      ...
      return D.defined(t) && (i.documentation = t), D.defined(n) ? i.parameters = n : i.parameters = [], i
    }
    e.create = t
  ...
  t.DocumentLink = P,
    function(e) {
      ...
      e.create = t, e.is = n
    }(P = t.DocumentLink || (t.DocumentLink = {})), t.DocumentLink = P, t.EOL = ["\n", "\r\n", "\r"];
  var _;
  ! function(e) {
    function t(e, t, n, r) {
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssCompletion", ["require", "exports", "../parser/cssNodes", "../parser/cssSymbolScope", "./languageFacts", "../utils/strings", "vscode-languageserver-types", "vscode-nls"], e)
  }(function(e, t) {
    function n(e) {
      return "undefined" != typeof e
    }
        ...
        return e.prototype.getSymbolContext = function() {
          ...
          try {
            ...
            for (var a = this.nodePath.length - 1; a >= 0; a--) {
              ...
              if (s instanceof i.Property) this.getCompletionsForDeclarationProperty(s.getParent(), o);
          ...
          for (var i in r)
            if (r.hasOwnProperty(i)) {
              ...
              if (o.browsers.onCodeComplete) {
                var c = void 0,
                  d = void 0;
                e ? (c = this.getCompletionRange(e.getProperty()), d = o.name + (n(e.colonPosition) ? "" : ": ")) : (c = this.getCompletionRange(null), d = o.name + ": ");
                var h = {
                  label: o.name,
          ...
          for (var n = this, r = e.getFullPropertyName(), i = a.getProperties()[r], o = e.getValue(); o && o.hasChildren();) o = o.findChildAtOffset(this.offset, !1);
          if (i) {
            ...
            var h = new m;
            this.styleSheet.accept(new f(r, h)), h.getEntries().forEach(function(e) {
              t.items.push({
                label: e,
          ...
          return e.values && e.values.forEach(function(e) {
            if (a.isCommonValue(e)) {
              var i = e.name,
                o = void 0;
              if (s.endsWith(i, ")")) {
                var c = i.lastIndexOf("("); - 1 !== c && (i = i.substr(0, c) + "($1)", o = h)
              }
              var d = {
                label: e.name,
          ...
          for (var r in a.cssWideKeywords) n.items.push({
            label: r,
          ...
          return r.forEach(function(r) {
            ...
            if (r.node.type === i.NodeType.FunctionParameter) {
              ...
              c.type === i.NodeType.MixinDeclaration && (a.detail = d("completion.argument", "argument from '{0}'", c.getName()))
            }
            t.items.push(a)
          }), t
          ...
          return t && t.parent && t.parent.type === i.NodeType.Term && (t = t.getParent()), e.restrictions.forEach(function(e) {
            var i = a.units[e];
          ...
          var o = new m;
          return this.styleSheet.accept(new g(o)), o.getEntries().forEach(function(e) {
            n.items.push({
              label: e,
          ...
          for (var r in a.positionKeywords) n.items.push({
            label: r,
          ...
          for (var r in a.repeatStyleKeywords) n.items.push({
            label: r,
          ...
          for (var r in a.lineStyleKeywords) n.items.push({
            label: r,
          ...
          var r = this;
          return a.lineWidthKeywords.forEach(function(e) {
            n.items.push({
              label: e,
              textEdit: l.TextEdit.replace(r.getCompletionRange(t), e),
              kind: l.CompletionItemKind.Value
          ...
          for (var r in a.geometryBoxKeywords) n.items.push({
            label: r,
          ...
          for (var r in a.boxKeywords) n.items.push({
            label: r,
          ...
          for (var r in a.imageFunctions) n.items.push({
            label: r,
          ...
          for (var r in a.transitionTimingFunctions) n.items.push({
            label: r,
          ...
          for (var r in a.basicShapeFunctions) n.items.push({
            label: r,
          ...
          var t = this;
          return a.getAtDirectives().forEach(function(n) {
          ...
          if (o) {
            for (var a = this.textDocument.offsetAt(this.defaultReplaceRange.start); a > 0 && ":" === this.textDocument.getText().charAt(a - 1);) a--;
          ...
          var r = this,
            o = this.findInNodePath(i.NodeType.PseudoSelector, i.NodeType.IdentifierSelector, i.NodeType.ClassSelector, i.NodeType.ElementNameSelector);
          !o && 0 === this.currentWord.length && this.offset > 0 && ":" === this.textDocument.getText()[this.offset - 1] && (this.currentWord = ":", this.defaultReplaceRange = l.Range.create(l.Position.create(this.position.line, this.position.character - 1), this.position)), a.getPseudoClasses().forEach(function(e) {
          ...
          }), t || (a.html5Tags.forEach(function(e) {
            n.items.push({
              label: e,
          ...
          if (this.styleSheet.accept(function(e) {
              if (e.type === i.NodeType.SimpleSelector && e.length > 0) {
                ...
                return "." !== t.charAt(0) || c[t] || (c[t] = !0, n.items.push({
                  label: t,
            ...
            h && 0 === e.getSelectors().getChildren().indexOf(h) && this.getPropertyProposals(null, n)
          }
          return n
          ...
          if (r instanceof i.AbstractDeclaration) {
            var o = r;
            if (!n(o.colonPosition || this.offset <= o.colonPosition)) return this.getCompletionsForDeclarationProperty(o, t);
            if (n(o.semicolonPosition) && o.semicolonPosition < this.offset) return this.offset === o.semicolonPosition + 1 ? t : this.getCompletionsForDeclarationProperty(null, t);
          ...
          if (e.getParent() instanceof i.FunctionArgument) return this.getCompletionsForFunctionArgument(e.getParent(), e.getParent().getParent(), t), t;
          ...
          return o.forEach(function(e) {
            e.node instanceof i.FunctionDeclaration && n.items.push(r.makeTermProposal(e, e.node.getParameters(), t))
          }), n
    ...
    var m = function() {
      ...
      g = function() {
        ...
        return e.prototype.visitNode = function(e) {
          return (e instanceof i.HexColorValue || e instanceof i.Function && a.isColorConstructor(e)) && this.entries.add(e.getText()), !0
        }, e
      }()
  });
var __extends = this && this.__extends || function() {
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/selectorPrinting", ["require", "exports", "../parser/cssNodes"], e)
}(function(e, t) {
  function n(e, t) {
    var n = new l;
    return e.getChildren().forEach(function(e) {
      switch (e.type) {
        ...
        case s.NodeType.AttributeSelector:
          ...
          if (c) {
            var d = void 0;
            if (c.getRight()) switch (c.getOperator().getText()) {
              case "|=":
  ...
  var m = function() {
    ...
    return e.prototype.processSelector = function(e) {
      ...
      e.getChildren().forEach(function(e) {
        ...
        }(e instanceof s.SimpleSelector || e.type === s.NodeType.SelectorCombinatorParent || e.type === s.NodeType.SelectorCombinatorShadowPiercingDescendant || e.type === s.NodeType.SelectorCombinatorSibling || e.type === s.NodeType.SelectorCombinatorAllSiblings) && (t.prev = e)
      })
    }, e
  }();
...
function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssHover", ["require", "exports", "../parser/cssNodes", "./languageFacts", "vscode-languageserver-types", "./selectorPrinting"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
  var n = e("../parser/cssNodes"),
    ...
    a = function() {
      function e() {}
      return e.prototype.doHover = function(e, t, a) {
        function s(t) {
        ...
        for (var l = e.offsetAt(t), c = n.getNodePath(a, l), d = 0; d < c.length; d++) {
          var h = c[d];
          if (h instanceof n.Selector) return {
            contents: o.selectorToMarkedString(h),
            range: s(h)
          };
          if (h instanceof n.SimpleSelector) return {
          ...
          if (h instanceof n.Declaration) {
            ...
            if (m) {
              ...
              if (f && u.push(i.MarkedString.fromPlainText(f)), u.length) return {
                contents: u,
                range: s(h)
              }
            }
...
function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssNavigation", ["require", "exports", "../parser/cssNodes", "vscode-languageserver-types", "../parser/cssSymbolScope", "../services/languageFacts", "vscode-nls"], e)
}(function(e, t) {
  function n(e, t) {
  ...
  function r(e) {
    ...
    if (e instanceof i.Identifier && e.parent && e.parent instanceof i.Property && e.isCustomProperty) return o.DocumentHighlightKind.Write;
    ...
    d = function() {
      ...
      return e.prototype.findDefinition = function(e, t, r) {
        ...
        return o.accept(function(t) {
          if (h) {
            if (d.matchesSymbol(t, h)) return s.push({
              kind: r(t),
              range: n(t, e)
            }), !1
          } else c.type === t.type && c.length === t.length && p === t.getText() && s.push({
            kind: r(t),
            range: n(t, e)
          });
          return !0
        ...
        return t.accept(function(t) {
          var a = {
            ...
            s = t;
          return t instanceof i.Selector ? (a.name = t.getText(), s = t.findParent(i.NodeType.Ruleset)) : t instanceof i.VariableDeclaration ? (a.name = t.getName(), a.kind = o.SymbolKind.Variable) : t instanceof i.MixinDeclaration ? (a.name = t.getName(), a.kind = o.SymbolKind.Method) : t instanceof i.FunctionDeclaration ? (a.name = t.getName(), a.kind = o.SymbolKind.Function) : t instanceof i.Keyframe ? a.name = c("literal.keyframes", "@keyframes {0}", t.getName()) : t instanceof i.FontFace && (a.name = c("literal.fontface", "@font-face")), a.name && (a.location = o.Location.create(e.uri, n(s, e)), r.push(a)), !0
        }), r
...
function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/lintRules", ["require", "exports", "../parser/cssNodes", "vscode-nls"], e)
}(function(e, t) {
  function n(e) {
    var n = {};
  ...
  t.Rule = d, t.Rules = {
    AllVendorPrefixes: new d("compatibleVendorPrefixes", a("rule.vendorprefixes.all", "When using a vendor-specific prefix make sure to also include all other vendor-specific properties"), c),
    IncludeStandardPropertyWhenUsingVendorPrefix: new d("vendorPrefix", a("rule.standardvendorprefix.all", "When using a vendor-specific prefix also include the standard property"), s),
    DuplicateDeclarations: new d("duplicateProperties", a("rule.duplicateDeclarations", "Do not use duplicate style definitions"), c),
    EmptyRuleSet: new d("emptyRules", a("rule.emptyRuleSets", "Do not use empty rulesets"), s),
    ImportStatemement: new d("importStatement", a("rule.importDirective", "Import statements do not load in parallel"), c),
    BewareOfBoxModelSize: new d("boxModel", a("rule.bewareOfBoxModelSize", "Do not use width or height when using padding or border"), c),
    UniversalSelector: new d("universalSelector", a("rule.universalSelector", "The universal selector (*) is known to be slow"), c),
    ZeroWithUnit: new d("zeroUnits", a("rule.zeroWidthUnit", "No unit for zero needed"), c),
    RequiredPropertiesForFontFace: new d("fontFaceProperties", a("rule.fontFaceProperties", "@font-face rule must define 'src' and 'font-family' properties"), s),
    HexColorLength: new d("hexColorLength", a("rule.hexColor", "Hex colors must consist of three or six hex numbers"), l),
    ArgsInColorFunction: new d("argumentsInColorFunction", a("rule.colorFunction", "Invalid number of parameters"), l),
    UnknownProperty: new d("unknownProperties", a("rule.unknownProperty", "Unknown property."), s),
    IEStarHack: new d("ieHack", a("rule.ieHack", "IE hacks are only necessary when supporting IE7 and older"), c),
    UnknownVendorSpecificProperty: new d("unknownVendorSpecificProperties", a("rule.unknownVendorSpecificProperty", "Unknown vendor specific property."), c),
    PropertyIgnoredDueToDisplay: new d("propertyIgnoredDueToDisplay", a("rule.propertyIgnoredDueToDisplay", "Property is ignored due to the display."), s),
    AvoidImportant: new d("important", a("rule.avoidImportant", "Avoid using !important. It is an indication that the specificity of the entire CSS has gotten out of control and needs to be refactored."), c),
    AvoidFloat: new d("float", a("rule.avoidFloat", "Avoid using 'float'. Floats lead to fragile CSS that is easy to break if one aspect of the layout changes."), c),
    AvoidIdSelector: new d("idSelector", a("rule.avoidIdSelector", "Selectors should not contain IDs because these rules are too tightly coupled with the HTML."), c)
...
function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssCodeActions", ["require", "exports", "../parser/cssNodes", "./languageFacts", "../utils/strings", "../services/lintRules", "vscode-languageserver-types", "vscode-nls"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
    ...
    c = function() {
      ...
      return e.prototype.doCodeActions = function(e, t, n, r) {
        ...
        for (var p = 3, m = 0, u = c; m < u.length; m++) {
          ...
          if (o.push(a.Command.create(b, "_css.applyCodeAction", e.uri, e.version, [y])), --p <= 0) return
        }
      }, e.prototype.appendFixesForMarker = function(e, t, r, i) {
        if (r.code === o.Rules.UnknownProperty.id)
          for (var a = e.offsetAt(r.range.start), s = e.offsetAt(r.range.end), l = n.getNodePath(t, a), c = l.length - 1; c >= 0; c--) {
            var d = l[c];
            if (d instanceof n.Declaration) {
              var h = d.getProperty();
              if (h && h.offset === a && h.end === s) return void this.getFixesForUnknownProperty(e, h, r, i)
            }
          }
      }, e
    }();
...
function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/lint", ["require", "exports", "./languageFacts", "./lintRules", "../parser/cssNodes", "vscode-nls"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
    ...
    c = function() {
      ...
      return e.entries = function(t, n) {
        ...
        for (var i = null, n = 0; n < e.length; n++) {
          var o = e[n];
          o && (i = null === i ? a("namelist.single", "'{0}'", o) : a("namelist.concatenated", "{0}, '{1}'", i, o))
        }
        return i
      }, e.prototype.visitNode = function(e) {
        switch (e.type) {
        ...
        var o = ["@-webkit-keyframes", "@-moz-keyframes", "@-o-keyframes"],
          s = function(e) {
            ...
            var l = function(e) {
                if (s) {
                  var n = a("keyframes.standardrule.missing", "Always define standard rule '@keyframes' when defining keyframes.");
                  t.addEntry(e, r.Rules.IncludeStandardPropertyWhenUsingVendorPrefix, n)
                }
                if (d) {
                  var n = a("keyframes.vendorspecific.missing", "Always include all vendor specific rules: Missing: {0}", d);
          ...
          if (p.length > 0) {
            ...
            if (["border", "border-left", "border-right", "padding", "padding-left", "padding-right"].forEach(function(e) {
                for (var t = o.fetch(h, e), n = 0, i = t; n < i.length; n++) {
                  var a = i[n],
                    s = a.node.getValue();
                  s && !s.matches("none") && (o.addEntry(a.node, r.Rules.BewareOfBoxModelSize), m = !0)
                }
              }), m)
          ...
          if (b.length > 0) {
            ...
            if (["border", "border-top", "border-bottom", "padding", "padding-top", "padding-bottom"].forEach(function(e) {
                for (var t = o.fetch(h, e), n = 0, i = t; n < i.length; n++) {
                  var a = i[n],
                    s = a.node.getValue();
                  s && !s.matches("none") && (o.addEntry(a.node, r.Rules.BewareOfBoxModelSize), y = !0)
                }
              }), y)
        ...
        if (k.length > 0 && ["width", "height", "margin-top", "margin-bottom", "float"].forEach(function(e) {
            for (var t = d.fetch(h, e), n = 0; n < t.length; n++) {
              var i = t[n].node,
                o = i.getValue();
              ("float" !== e || o && !o.matches("none")) && d.addEntry(i, r.Rules.PropertyIgnoredDueToDisplay, a("rule.propertyIgnoredDueToDisplayInline", "Property is ignored due to the display. With 'display: inline', the width, height, margin-top, margin-bottom, and float properties have no effect."))
            }
          }), k = this.fetchWithValue(h, "display", "inline-block"), k.length > 0)
          for (var T = this.fetch(h, "float"), S = 0; S < T.length; S++) {
            var F = T[S].node,
              C = F.getValue();
            C && !C.matches("none") && this.addEntry(F, r.Rules.PropertyIgnoredDueToDisplay, a("rule.propertyIgnoredDueToDisplayInlineBlock", "inline-block is ignored due to the float. If 'float' has a value other than 'none', the box is floated and 'display' is treated as 'block'"))
          }
        if (k = this.fetchWithValue(h, "display", "block"), k.length > 0)
          for (var T = this.fetch(h, "vertical-align"), S = 0; S < T.length; S++) this.addEntry(T[S].node, r.Rules.PropertyIgnoredDueToDisplay, a("rule.propertyIgnoredDueToDisplayBlock", "Property is ignored due to the display. With 'display: block', vertical-align should not be used."));
        t.accept(function(e) {
          return e.type === i.NodeType.Prio && d.addEntry(e, r.Rules.AvoidImportant), !0
        });
        for (var E = this.fetch(h, "float"), S = 0; S < E.length; S++) this.addEntry(E[S].node, r.Rules.AvoidFloat);
            ...
            if (C && "-" !== C.getText()[0]) {
              ...
              if (_.length > 1)
                for (var A = 0; A < _.length; A++) {
                  ...
                  D && "-" !== D.getText()[0] && _[A] !== P && this.addEntry(P.node, r.Rules.DuplicateDeclarations)
                }
            }
          }
        }
        ...
        if (c.getChildren().forEach(function(e) {
            if (o.isCSSDeclaration(e)) {
              ...
              } else "*" !== a && "_" !== a || (o.addEntry(t.getProperty(), r.Rules.IEStarHack), i = i.substr(1)), n.isKnownProperty(i) || o.addEntry(t.getProperty(), r.Rules.UnknownProperty), O.add(i, i, null)
            } else R = !0
          }), !R) {
          var z = function(t) {
              var i = O.data[t],
              ...
              var m = function(e) {
                  if (l) {
                    var n = a("property.standard.missing", "Also define the standard property '{0}' for compatibility", t);
                    o.addEntry(e, r.Rules.IncludeStandardPropertyWhenUsingVendorPrefix, n)
                  }
                  if (u) {
                    var n = a("property.vendorspecific.missing", "Always include all vendor specific properties: Missing: {0}", u);
        ...
        var t = e.getValue();
        return t.unit && -1 !== n.units.length.indexOf(t.unit.toLowerCase()) ? (0 === parseFloat(t.value) && t.unit && this.addEntry(e, r.Rules.ZeroWithUnit), !0) : !0
        ...
        if (n) {
          ...
          }), a || i && o || this.addEntry(e, r.Rules.RequiredPropertiesForFontFace), !0
        }
...
function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/cssValidation", ["require", "exports", "../parser/cssNodes", "vscode-languageserver-types", "./lintRules", "./lint"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
  var n = e("../parser/cssNodes"),
    ...
    a = function() {
      ...
      return e.prototype.configure = function(e) {
        this.validationEnabled = !e || e.validate !== !1, this.lintSettings = i.sanitize(e && e.lint || {})
        ...
        var a = [];
        return a.push.apply(a, n.ParseErrorCollector.entries(t)), a.push.apply(a, o.LintVisitor.entries(t, this.lintSettings)), a.filter(function(e) {
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/scssScanner", ["require", "exports", "./cssScanner"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
  ...
  var g = function(e) {
    ...
    return __extends(f, e), f.prototype.scanNext = function(r) {
      ...
      return this.stream.advanceIfChars([l, c]) ? this.finishToken(r, t.InterpolationFunction) : this.stream.advanceIfChars([d, d]) ? this.finishToken(r, t.EqualsOperator) : this.stream.advanceIfChars([h, d]) ? this.finishToken(r, t.NotEqualsOperator) : this.stream.advanceIfChar(p) ? this.stream.advanceIfChar(d) ? this.finishToken(r, t.SmallerEqualsOperator) : this.finishToken(r, n.TokenType.Delim) : this.stream.advanceIfChar(m) ? this.stream.advanceIfChar(d) ? this.finishToken(r, t.GreaterEqualsOperator) : this.finishToken(r, n.TokenType.Delim) : this.stream.advanceIfChars([u, u, u]) ? this.finishToken(r, t.Ellipsis) : e.prototype.scanNext.call(this, r)
    }, f.prototype.comment = function() {
      return e.prototype.comment.call(this) ? !0 : this.stream.advanceIfChars([r, r]) ? (this.stream.advanceWhileChar(function(e) {
        switch (e) {
          case i:
          case o:
          case a:
...
function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/scssErrors", ["require", "exports", "vscode-nls"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/scssParser", ["require", "exports", "./scssScanner", "./cssScanner", "./cssParser", "./cssNodes", "./scssErrors", "./cssErrors"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
  var n = e("./scssScanner"),
    ...
    l = function(e) {
      ...
      return __extends(t, e), t.prototype._parseStylesheetStatement = function() {
        ...
        if (!e.addChild(this._parseURILiteral()) && !e.addChild(this._parseStringLiteral())) return this.finish(e, s.ParseError.URIOrStringExpected);
        ...
        if (t.colonPosition = this.prevToken.offset, !t.setValue(this._parseExpr())) return this.finish(t, s.ParseError.VariableValueExpected, [], e);
        for (; this.accept(r.TokenType.Exclamation);)
          if (!this.acceptOne(r.TokenType.Ident, ["default", "global"], !1)) return this.finish(t, s.ParseError.UnknownKeyword);
        ...
        t.referenceTypes = e;
        for (var n = !1;
          (this.accept(r.TokenType.Ident) || t.addChild(this._parseInterpolation())) && (n = !0, !this.hasWhitespace() && this.accept(r.TokenType.Delim, "-"), !this.hasWhitespace()););
        return n ? this.finish(t) : null
        ...
        return this.accept(n.InterpolationFunction) ? e.addChild(this._parseBinaryExpr()) || this._parseSelectorCombinator() ? this.accept(r.TokenType.CurlyR) ? this.finish(e) : this.finish(e, s.ParseError.RightCurlyExpected) : this.finish(e, s.ParseError.ExpressionExpected) : null
        ...
        return this.peek(r.TokenType.AtKeyword) ? this._parseKeyframe() || this._parseImport() || this._parseMedia(!0) || this._parseFontFace() || this._parseWarnAndDebug() || this._parseControlStatement() || this._parseFunctionDeclaration() || this._parseExtends() || this._parseMixinReference() || this._parseMixinContent() || this._parseMixinDeclaration() || this._parseRuleset(!0) : this._parseVariableDeclaration() || this._tryParseRuleset(!0) || e.prototype._parseRuleSetDeclaration.call(this)
      }, t.prototype._parseDeclaration = function(e) {
        var t = this.create(o.Declaration);
        if (!t.setProperty(this._parseProperty())) return null;
        if (!this.accept(r.TokenType.Colon, ":")) return this.finish(t, s.ParseError.ColonExpected, [r.TokenType.Colon], e);
        t.colonPosition = this.prevToken.offset;
        var n = !1;
        if (t.setValue(this._parseExpr()) && (n = !0, t.addChild(this._parsePrio())), this.peek(r.TokenType.CurlyL)) t.setNestedProperties(this._parseNestedProperties());
        ...
        return this.accept(r.TokenType.AtKeyword, "@extend") ? e.setSelector(this._parseSimpleSelector()) ? this.accept(r.TokenType.Exclamation) && !this.accept(r.TokenType.Ident, "optional", !0) ? this.finish(e, s.ParseError.UnknownKeyword) : this.finish(e) : this.finish(e, s.ParseError.SelectorExpected) : null
        ...
        if (this.accept(r.TokenType.Delim, "&")) {
          for (; !this.hasWhitespace() && (this.accept(r.TokenType.Delim, "-") || this.accept(r.TokenType.Num) || e.addChild(this._parseIdent()) || this.accept(r.TokenType.Delim, "&")););
          return this.finish(e)
        }
        return null
        ...
        if (!this.peek(r.TokenType.AtKeyword, "@debug") && !this.peek(r.TokenType.AtKeyword, "@warn") && !this.peek(r.TokenType.AtKeyword, "@error")) return null;
        ...
        if (this.consumeToken(), !t.setExpression(this._parseExpr(!0))) return this.finish(t, s.ParseError.ExpressionExpected);
        ...
        if (!n.addChild(this._parseVariable())) return this.finish(t, s.ParseError.VariableNameExpected, [r.TokenType.CurlyR]);
        for (; this.accept(r.TokenType.Comma);)
          if (!n.addChild(this._parseVariable())) return this.finish(t, s.ParseError.VariableNameExpected, [r.TokenType.CurlyR]);
        return this.finish(n), this.accept(r.TokenType.Ident, "in") ? t.addChild(this._parseExpr()) ? this._parseBody(t, e) : this.finish(t, s.ParseError.ExpressionExpected, [r.TokenType.CurlyR]) : this.finish(t, a.SCSSParseError.InExpected, [r.TokenType.CurlyR])
        ...
        return this.consumeToken(), t.addChild(this._parseBinaryExpr()) ? this._parseBody(t, e) : this.finish(t, s.ParseError.ExpressionExpected, [r.TokenType.CurlyR])
        ...
        if (this.consumeToken(), !e.setIdentifier(this._parseIdent([o.ReferenceType.Function]))) return this.finish(e, s.ParseError.IdentifierExpected, [r.TokenType.CurlyR]);
        if (!this.accept(r.TokenType.ParenthesisL)) return this.finish(e, s.ParseError.LeftParenthesisExpected, [r.TokenType.CurlyR]);
        if (e.getParameters().addChild(this._parseParameterDeclaration()))
          for (; this.accept(r.TokenType.Comma);)
            if (!e.getParameters().addChild(this._parseParameterDeclaration())) return this.finish(e, s.ParseError.VariableNameExpected);
        return this.accept(r.TokenType.ParenthesisR) ? this._parseBody(e, this._parseFunctionBodyDeclaration.bind(this)) : this.finish(e, s.ParseError.RightParenthesisExpected, [r.TokenType.CurlyR])
        ...
        return this.consumeToken(), e.addChild(this._parseExpr()) ? this.finish(e) : this.finish(e, s.ParseError.ExpressionExpected)
        ...
        if (this.consumeToken(), !e.setIdentifier(this._parseIdent([o.ReferenceType.Mixin]))) return this.finish(e, s.ParseError.IdentifierExpected, [r.TokenType.CurlyR]);
        if (this.accept(r.TokenType.ParenthesisL)) {
          if (e.getParameters().addChild(this._parseParameterDeclaration()))
            for (; this.accept(r.TokenType.Comma);)
              if (!e.getParameters().addChild(this._parseParameterDeclaration())) return this.finish(e, s.ParseError.VariableNameExpected);
          if (!this.accept(r.TokenType.ParenthesisR)) return this.finish(e, s.ParseError.RightParenthesisExpected, [r.TokenType.CurlyR])
        }
        return this._parseBody(e, this._parseRuleSetDeclaration.bind(this))
      }, t.prototype._parseParameterDeclaration = function() {
        var e = this.create(o.FunctionParameter);
        return e.setIdentifier(this._parseVariable()) ? (this.accept(n.Ellipsis), this.accept(r.TokenType.Colon) && !e.setDefaultValue(this._parseExpr(!0)) ? this.finish(e, s.ParseError.VariableValueExpected, [], [r.TokenType.Comma, r.TokenType.ParenthesisR]) : this.finish(e)) : null
        ...
        if (this.accept(r.TokenType.ParenthesisL)) {
          if (e.getArguments().addChild(this._parseFunctionArgument()))
            for (; this.accept(r.TokenType.Comma);)
              if (!e.getArguments().addChild(this._parseFunctionArgument())) return this.finish(e, s.ParseError.ExpressionExpected);
          if (!this.accept(r.TokenType.ParenthesisR)) return this.finish(e, s.ParseError.RightParenthesisExpected)
        }
        ...
        return e.addChild(this._parseBinaryExpr()) ? this.accept(r.TokenType.Colon) && !e.addChild(this._parseBinaryExpr()) ? this.finish(e, s.ParseError.ExpressionExpected) : this.finish(e) : null
      }, t
    }(i.Parser);
  t.SCSSParser = l
});
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/scssCompletion", ["require", "exports", "./cssCompletion", "vscode-languageserver-types", "vscode-nls"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/lessScanner", ["require", "exports", "./cssScanner"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
  ...
  var d = function(e) {
    ...
    return __extends(c, e), c.prototype.scanNext = function(n) {
      ...
      return null !== r ? this.finishToken(n, r) : this.stream.advanceIfChars([l, l, l]) ? this.finishToken(n, t.Ellipsis) : e.prototype.scanNext.call(this, n)
      ...
      return e === s ? (this.stream.advance(1), this.stream.advanceWhileChar(function(e) {
        return e !== s
      }), this.stream.advanceIfChar(s) ? n.TokenType.EscapedJavaScript : n.TokenType.BadEscapedJavaScript) : null
    }, c
  }(n.Scanner);
  t.LESSScanner = d
});
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/parser/lessParser", ["require", "exports", "./lessScanner", "./cssScanner", "./cssParser", "./cssNodes", "./cssErrors"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
  var n = e("./lessScanner"),
    ...
    s = function(e) {
      ...
      return __extends(t, e), t.prototype._parseStylesheetStatement = function() {
        ...
        var e = this.create(o.Import);
        if (!this.accept(r.TokenType.AtKeyword, "@import") && !this.accept(r.TokenType.AtKeyword, "@import-once")) return null;
        if (this.accept(r.TokenType.ParenthesisL)) {
          if (!this.accept(r.TokenType.Ident)) return this.finish(e, a.ParseError.IdentifierExpected, [r.TokenType.SemiColon]);
          do
            if (!this.accept(r.TokenType.Comma)) break; while (this.accept(r.TokenType.Ident));
          if (!this.accept(r.TokenType.ParenthesisR)) return this.finish(e, a.ParseError.RightParenthesisExpected, [r.TokenType.SemiColon])
        }
        return e.addChild(this._parseURILiteral()) || e.addChild(this._parseStringLiteral()) ? (e.setMedialist(this._parseMediaList()), this.finish(e)) : this.finish(e, a.ParseError.URIOrStringExpected, [r.TokenType.SemiColon])
        ...
        return this.accept(r.TokenType.EscapedJavaScript) || this.accept(r.TokenType.BadEscapedJavaScript) ? this.finish(e) : this.accept(r.TokenType.Delim, "~") ? this.finish(e, this.accept(r.TokenType.String) ? null : a.ParseError.TermExpected) : null
      }, t.prototype._parseOperator = function() {
        ...
        return this.peek(r.TokenType.AtKeyword) ? this._parseKeyframe() || this._parseMedia(!0) || this._parseImport() || this._parseDetachedRuleSetMixin() || this._parseVariableDeclaration() : this._tryParseMixinDeclaration() || this._tryParseRuleset(!0) || this._tryParseMixinReference() || this._parseExtend() || e.prototype._parseRuleSetDeclaration.call(this)
      }, t.prototype._parseSimpleSelectorBody = function() {
        ...
        if (t.getParameters().addChild(this._parseMixinParameter()))
          for (;
            ...
            if (!t.getParameters().addChild(this._parseMixinParameter())) return this.finish(t, a.ParseError.IdentifierExpected);
        ...
        if (this.peek(r.TokenType.Delim, "#") || this.peek(r.TokenType.Delim, ".")) {
          if (e = this.create(o.Identifier), this.consumeToken(), this.hasWhitespace() || !e.addChild(this._parseIdent())) return null
        } else {
        ...
        return this.accept(r.TokenType.ParenthesisL) ? e.setSelector(this._parseSelector(!0)) ? this.accept(r.TokenType.ParenthesisR) ? this.finish(e) : this.finish(e, a.ParseError.RightParenthesisExpected) : this.finish(e, a.ParseError.SelectorExpected) : this.finish(e, a.ParseError.LeftParenthesisExpected)
        ...
        return t.addChild(this._parseVariable()) && this.accept(r.TokenType.ParenthesisL) ? this.accept(r.TokenType.ParenthesisR) ? this.finish(t) : this.finish(t, a.ParseError.RightParenthesisExpected) : (this.restoreAtMark(e), null)
        ...
        if (!this.hasWhitespace() && this.accept(r.TokenType.ParenthesisL)) {
          if (n.getArguments().addChild(this._parseMixinArgument()))
            for (;
              (this.accept(r.TokenType.Comma) || this.accept(r.TokenType.SemiColon)) && !this.peek(r.TokenType.ParenthesisR);)
              if (!n.getArguments().addChild(this._parseMixinArgument())) return this.finish(n, a.ParseError.ExpressionExpected);
          if (!this.accept(r.TokenType.ParenthesisR)) return this.finish(n, a.ParseError.RightParenthesisExpected);
        ...
        if (this.peek(r.TokenType.AtKeyword, "@rest")) {
          var t = this.create(o.Node);
          return this.consumeToken(), this.accept(n.Ellipsis) ? (e.setIdentifier(this.finish(t)), this.finish(e)) : this.finish(e, a.ParseError.DotExpected, [], [r.TokenType.Comma, r.TokenType.ParenthesisR])
        }
        ...
        var s = !1;
        return e.setIdentifier(this._parseVariable()) && (this.accept(r.TokenType.Colon), s = !0), e.setDefaultValue(this._parseExpr(!0)) || s ? this.finish(e) : null
      }, t.prototype._parseGuard = function() {
        if (!this.peek(r.TokenType.Ident, "when")) return null;
        var e = this.create(o.LessGuard);
        if (this.consumeToken(), e.isNegated = this.accept(r.TokenType.Ident, "not"), !e.getConditions().addChild(this._parseGuardCondition())) return this.finish(e, a.ParseError.ConditionExpected);
        for (; this.accept(r.TokenType.Ident, "and") || this.accept(r.TokenType.Comma, ",");)
          if (!e.getConditions().addChild(this._parseGuardCondition())) return this.finish(e, a.ParseError.ConditionExpected);
        return this.finish(e)
      }, t.prototype._parseGuardCondition = function() {
        var e = this.create(o.GuardCondition);
        return this.accept(r.TokenType.ParenthesisL) ? (!e.addChild(this._parseExpr()), this.accept(r.TokenType.ParenthesisR) ? this.finish(e) : this.finish(e, a.ParseError.RightParenthesisExpected)) : null
...
! function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/services/lessCompletion", ["require", "exports", "./cssCompletion", "vscode-languageserver-types", "vscode-nls"], e)
}(function(e, t) {
  Object.defineProperty(t, "__esModule", {
    value: !0
  });
...
function(e) {
  if ("object" == typeof module && "object" == typeof module.exports) {
    var t = e(require, exports);
    void 0 !== t && (module.exports = t)
  } else "function" == typeof define && define.amd && define("vscode-css-languageservice/cssLanguageService", ["require", "exports", "./parser/cssParser", "./services/cssCompletion", "./services/cssHover", "./services/cssNavigation", "./services/cssCodeActions", "./services/cssValidation", "./parser/scssParser", "./services/scssCompletion", "./parser/lessParser", "./services/lessCompletion"], e)
}(function(e, t) {
  ...
  function r() {
    return n(new a.Parser, new s.CSSCompletion, new l.CSSHover, new c.CSSNavigation, new d.CSSCodeActions, new h.CSSValidation)
  }
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var t = e(require, exports);
      void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vs/language/css/cssWorker", ["require", "exports", "vscode-css-languageservice", "vscode-languageserver-types"], e)
  }(function(e, t) {
    function n(e, t) {
      return new a(e, t)
    }
