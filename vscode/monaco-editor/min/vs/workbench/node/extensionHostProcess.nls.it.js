...
define("vs/workbench/node/extensionHostProcess.nls.it", {
  ...
  "vs/base/node/processes": ["Non è possibile eseguire un comando della shell su un'unità UNC."],
  ...
  "vs/platform/workspaces/common/workspaces": ["Area di lavoro del codice", "Senza titolo (Area di lavoro)", "{0} (Area di lavoro)", "{0} (Area di lavoro)"],
  "vs/workbench/api/node/extHostDiagnostics": ["Non verranno visualizzati altri {0} errori e avvisi."],
  ...
  "vs/workbench/api/node/extHostTreeViews": ["Nessuna visualizzazione di struttura ad albero con ID '{0}' registrata.", "Nessuna visualizzazione di struttura ad albero con ID '{0}' registrata.", "Nessun elemento di struttura ad albero con id '{0}' trovato."],
  "vs/workbench/node/extensionHostMain": ["Il percorso {0} non punta a un Test Runner di estensioni valido."]
});
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/ca023a700f35212071dfe9544272719cbbf80e4c/core/vs\workbench\node\extensionHostProcess.nls.it.js.map