...
define("vs/workbench/node/extensionHostProcess.nls.fr", {
  ...
  "vs/workbench/api/node/extHostDiagnostics": ["Les {0} erreurs et avertissements supplémentaires ne sont pas affichés."],
  ...
  "vs/workbench/api/node/extHostTreeViews": ["Aucune arborescence avec l'ID '{0}' n'est inscrite.", "Aucune arborescence avec l'ID '{0}' n'est inscrite.", "L'élément d'arborescence avec l'ID '{0}' est introuvable."],
  "vs/workbench/node/extensionHostMain": ["Le chemin {0} ne pointe pas vers un Test Runner d'extension valide."]
});
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/ca023a700f35212071dfe9544272719cbbf80e4c/core/vs\workbench\node\extensionHostProcess.nls.fr.js.map