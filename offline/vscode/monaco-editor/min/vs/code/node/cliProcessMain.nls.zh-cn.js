...
define("vs/code/node/cliProcessMain.nls.zh-cn", {
  ...
  "vs/code/node/cliProcessMain": ["找不到扩展“{0}”。", "未安装扩展“{0}”。", "确保使用完整扩展 ID，包括发布服务器，如: {0}", "已成功安装扩展“{0}”!", "已取消安装扩展“{0}”。", "已安装扩展“{0}”。", "在商店中找到了“{0}”。", "正在安装...", "已成功安装扩展“{0}” v{1}!", "已取消安装扩展“{0}”。", "正在卸载 {0}...", "已成功卸载扩展“{0}”!"],
