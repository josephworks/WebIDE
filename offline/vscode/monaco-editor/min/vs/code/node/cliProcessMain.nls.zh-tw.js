...
define("vs/code/node/cliProcessMain.nls.zh-tw", {
  ...
  "vs/code/node/cliProcessMain": ["找不到擴充功能 '{0}'。", "未安裝擴充功能 '{0}'。", "請確定您使用完整擴充功能識別碼 (包括發行者)，例如: {0}", "已成功安裝延伸模組 '{0}'!", '已取消安裝擴充功能 "{0}"。', "已安裝過擴充功能 '{0}'。", "在市集中找到 '{0}'。", "正在安裝...", "已成功安裝擴充功能 '{0}' v{1}!", '已取消安裝擴充功能 "{0}"。', "正在將 {0} 解除安裝...", "已成功將擴充功能 '{0}' 解除安裝!"],
