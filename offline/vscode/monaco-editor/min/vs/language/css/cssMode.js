...
! function(e) {
  ...
  } else "function" == typeof define && define.amd && define("vs/language/css/workerManager", ["require", "exports"], e)
}(function(e, n) {
  function t(e) {
    var n, t, i = new r(function(e, r) {
      n = e, t = r
    }, function() {});
    return e.then(n, t), i
  }
...
function(e) {
  ...
  ! function(e) {
    function n(e, n, r, i) {
      if (A.number(e) && A.number(n) && A.number(r) && A.number(i)) return {
        start: t.create(e, n),
        end: t.create(r, i)
      };
      ...
      throw new Error("Range#create called with invalid arguments[" + e + ", " + n + ", " + r + ", " + i + "]")
    }
  ...
  ! function(e) {
    function n(e, n, t, r, i) {
      ...
      return A.defined(t) && (o.severity = t), A.defined(r) && (o.code = r), A.defined(i) && (o.source = i), o
    }
      ...
      return Object.defineProperty(e.prototype, "edit", {
        ...
        if (g.is(e)) {
          ...
          if (!t) {
            ...
            this._workspaceEdit.documentChanges.push(i), t = new d(r), this._textEditChanges[n.uri] = t
          }
          return t
        }
        if (this._workspaceEdit || (this._workspaceEdit = {
  ...
  ! function(e) {
    function n(e, n) {
      ...
      return A.defined(n) && (i.documentation = n), A.defined(t) ? i.parameters = t : i.parameters = [], i
    }
    e.create = n
  ...
  n.DocumentLink = T,
    function(e) {
      ...
      e.create = n, e.is = t
    }(T = n.DocumentLink || (n.DocumentLink = {})), n.DocumentLink = T, n.EOL = ["\n", "\r\n", "\r"];
  var E;
  ! function(e) {
    function n(e, n, t, r) {
  ...
  ! function(e) {
    ...
    e.defined = n, e.undefined = t, e["boolean"] = r, e.string = i, e.number = o, e.func = a, e.typedArray = u
  }(A || (A = {}))
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var n = e(require, exports);
      void 0 !== n && (module.exports = n)
    } else "function" == typeof define && define.amd && define("vs/language/css/languageFeatures", ["require", "exports", "vscode-languageserver-types"], e)
  }(function(e, n) {
    function t(e) {
      switch (e) {
    ...
    var g = e("vscode-languageserver-types"),
      ...
      h = function() {
        function e(e, n) {
          ...
          this._disposables.push(monaco.editor.onDidCreateModel(r)), this._disposables.push(monaco.editor.onWillDisposeModel(i)), this._disposables.push(monaco.editor.onDidChangeModelLanguage(function(e) {
            i(e.model), r(e.model)
    ...
    var v = function() {
      ...
      return Object.defineProperty(e.prototype, "triggerCharacters", {
        ...
        return l(t, this._worker(r).then(function(e) {
          ...
          if (e) {
            var n = e.items.map(function(e) {
              ...
              return e.textEdit && (n.range = o(e.textEdit.range), n.insertText = e.textEdit.newText), e.insertTextFormat === g.InsertTextFormat.Snippet && (n.insertText = {
                value: n.insertText
              }), n
            });
            return {
    ...
    var C = function() {
      ...
      return e.prototype.provideReferences = function(e, n, t, r) {
        var o = e.uri;
        return l(r, this._worker(o).then(function(e) {
    ...
    var I = function() {
      ...
      return e.prototype.provideDocumentSymbols = function(e, n) {
        var t = e.uri;
        return l(n, this._worker(t).then(function(e) {
  ...
  function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
      var n = e(require, exports);
      void 0 !== n && (module.exports = n)
    } else "function" == typeof define && define.amd && define("vs/language/css/cssMode", ["require", "exports", "./workerManager", "./languageFeatures"], e)
  }(function(e, n) {
    function t(e) {
      var n = [],
      ...
      var o = function(e) {
        ...
        a = e.languageId;
      n.push(monaco.languages.registerCompletionItemProvider(a, new i.CompletionAdapter(o))), n.push(monaco.languages.registerHoverProvider(a, new i.HoverAdapter(o))), n.push(monaco.languages.registerDocumentHighlightProvider(a, new i.DocumentHighlightAdapter(o))), n.push(monaco.languages.registerDefinitionProvider(a, new i.DefinitionAdapter(o))), n.push(monaco.languages.registerReferenceProvider(a, new i.ReferenceAdapter(o))), n.push(monaco.languages.registerDocumentSymbolProvider(a, new i.DocumentSymbolAdapter(o))), n.push(monaco.languages.registerRenameProvider(a, new i.RenameAdapter(o))), n.push(new i.DiagnostcsAdapter(a, o))
    }
    Object.defineProperty(n, "__esModule", {
      value: !0
    });
